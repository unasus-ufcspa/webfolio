...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/webfolio/uploads'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/web/uploads' ;// Physical path. [Usually works fine like this]
        //servidor '/var/www/webapps/webfolio/web/uploads'
